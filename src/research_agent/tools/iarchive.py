...
_register_kind(
    ...
    search_fn=search,
    fetch_fn=fetch,
    host_patterns=("archive.org", "www.archive.org"),
    description=(
        "Internet Archive texts, audio, movies, and web-archive collection"
        " metadata through advancedsearch.php"
    ),
    optional_payload_knobs="`mediatype: texts\\|audio\\|movies\\|web`, `page: <int>`",
    example_query="Pullman Strike",
    module_name="iarchive",
)
