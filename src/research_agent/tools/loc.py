...
_register_kind(
    ...
    search_fn=search,
    fetch_fn=fetch,
    host_patterns=("loc.gov", "www.loc.gov"),
    description=(
        "Library of Congress digital collections, including Chronicling"
        " America through the unified loc.gov API"
    ),
    optional_payload_knobs=(
        "`collection: chronicling-america\\|prints\\|manuscripts\\|recordings\\|maps`, "
        "`page: <int>`"
    ),
    example_query="battle of algiers",
    module_name="loc",
)
